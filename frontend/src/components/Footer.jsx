...
const Footer = () => {
  ...
  return !isPlaceOrder ? (
    <div className="p-4 pl-8 bg-green-800 dark:bg-black">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-10 text-sm">
        <div>
          <img src={assets.logo} alt="" className="mb-5 w-32" />
          <p className="w-full md:w-2/3 text-gray-300">
            heelloo there blah blah yeahah
          </p>
        </div>
      ...
      <div>
        <p className="py-3 text-sm text-center text-gray-300">
          Copyright your mum lmao
        </p>
      </div>
    </div>
  ) : null;
